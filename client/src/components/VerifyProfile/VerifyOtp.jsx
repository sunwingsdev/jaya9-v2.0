...
const VerifyOtp = ({isOtpOpen,setIsOtpOpen,isBengali,otp,handleChangeOtp,handleReload,generatedOtp,memberInfo}) => {
    return (
        <div>
            {isOtpOpen && (
            <div
            ...
            >
              <div className="bg-white  rounded-lg w-96 shadow-lg">
                <div className="flex flex-row justify-between bg-common-blue p-4">
                  ...
                  {isBengali ? "ফোন নম্বর যাচাই করুন" : "Verify Phone Number"}
