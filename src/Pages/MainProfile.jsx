...
const MainProfile = () => {
  ...
  const dataEn = [
    ...
    },
    {
        title: "History",
        titleClass: "text-black",
        gridClass: "grid-cols-2 justify-items-center lg:justify-items-center lg:grid-cols-5",
        sectionClass: "mt-2",
        items: [
            {
                imgSrc: bajilogo,
    ...
    },
    {
        title: "Profile",
        titleClass: "text-black",
        gridClass: "grid-cols-2 justify-items-center lg:justify-items-center lg:grid-cols-6",
        sectionClass: "mt-2",
        items: [
            {
                imgSrc: infologo,
